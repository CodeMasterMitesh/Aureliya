...
const ChemicalanalysisconditionSchema = new Schema({
...
export default mongoose.model('Chemicalanalysiscondition', ChemicalanalysisconditionSchema, 'chemicalanalysiscondition')
