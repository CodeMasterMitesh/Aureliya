...
const MobilephasepreparationchemicalsSchema = new Schema({
...
export default mongoose.model('Mobilephasepreparationchemicals', MobilephasepreparationchemicalsSchema, 'mobilephasepreparationchemicals')
