...
const InternalaudititemsSchema = new Schema({
  ...
  internalauditid: { type: Number }, // internalauditid int(11)
  sort: { type: Number }, // sort int(11)
}, { timestamps: false })

export default mongoose.model('Internalaudititems', InternalaudititemsSchema, 'internalaudititems')
