...
const OtherpurchasereturnitemsSchema = new Schema({
  id: { type: Number }, // id int(11)
  otherpurchsereturnid: { type: Number }, // otherpurchsereturnid int(11)
...
export default mongoose.model('Otherpurchasereturnitems', OtherpurchasereturnitemsSchema, 'otherpurchasereturnitems')
