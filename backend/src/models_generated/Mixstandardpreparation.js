...
const MixstandardpreparationSchema = new Schema({
  ...
  standardpreprationdate: { type: Date }, // standardpreprationdate date
...
export default mongoose.model('Mixstandardpreparation', MixstandardpreparationSchema, 'mixstandardpreparation')
