...
const DissolutionmediumpreparationSchema = new Schema({
  ...
  dissolutionmediumpreparationdate: { type: Date }, // dissolutionmediumpreparationdate date
...
export default mongoose.model('Dissolutionmediumpreparation', DissolutionmediumpreparationSchema, 'dissolutionmediumpreparation')
