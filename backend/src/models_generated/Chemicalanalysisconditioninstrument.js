...
const ChemicalanalysisconditioninstrumentSchema = new Schema({
  id: { type: Number }, // id int(11)
  chemicalanalysisconditionid: { type: Number }, // chemicalanalysisconditionid int(11)
...
export default mongoose.model('Chemicalanalysisconditioninstrument', ChemicalanalysisconditioninstrumentSchema, 'chemicalanalysisconditioninstrument')
