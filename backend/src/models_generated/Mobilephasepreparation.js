...
const MobilephasepreparationSchema = new Schema({
  ...
  mobilephasepreparationdate: { type: Date }, // mobilephasepreparationdate date
...
export default mongoose.model('Mobilephasepreparation', MobilephasepreparationSchema, 'mobilephasepreparation')
