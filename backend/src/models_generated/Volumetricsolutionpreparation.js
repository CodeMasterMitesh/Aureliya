...
const VolumetricsolutionpreparationSchema = new Schema({
  ...
  volumetricsolutionpreparationdate: { type: Date }, // volumetricsolutionpreparationdate date
...
export default mongoose.model('Volumetricsolutionpreparation', VolumetricsolutionpreparationSchema, 'volumetricsolutionpreparation')
