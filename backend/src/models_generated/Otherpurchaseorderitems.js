...
const OtherpurchaseorderitemsSchema = new Schema({
  ...
  supplierstate: { type: String }, // supplierstate varchar(200)
}, { timestamps: false })

export default mongoose.model('Otherpurchaseorderitems', OtherpurchaseorderitemsSchema, 'otherpurchaseorderitems')
