...
const ReagentpreparationSchema = new Schema({
  ...
  reagentpreparationdate: { type: Date }, // reagentpreparationdate date
...
export default mongoose.model('Reagentpreparation', ReagentpreparationSchema, 'reagentpreparation')
