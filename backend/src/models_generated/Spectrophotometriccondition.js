...
const SpectrophotometricconditionSchema = new Schema({
...
export default mongoose.model('Spectrophotometriccondition', SpectrophotometricconditionSchema, 'spectrophotometriccondition')
