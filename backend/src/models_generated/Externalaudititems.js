...
const ExternalaudititemsSchema = new Schema({
  id: { type: Number }, // id int(11)
  value: { type: String }, // value varchar(255)
  qcname: { type: String }, // qcname varchar(100)
  ...
  externalauditid: { type: Number }, // externalauditid int(11)
  sort: { type: Number }, // sort int(11)
}, { timestamps: false })

export default mongoose.model('Externalaudititems', ExternalaudititemsSchema, 'externalaudititems')
