...
const DissolutionSchema = new Schema({
  ...
  dissolutiondate: { type: Date }, // dissolutiondate date
...
export default mongoose.model('Dissolution', DissolutionSchema, 'dissolution')
