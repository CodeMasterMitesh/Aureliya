...
async function run(){
  ...
  await Blog.insertMany([
    { slug: 'welcome-to-our-store', title: 'Welcome to our store', excerpt: 'Discover what makes our experience different.', image: 'https://picsum.photos/seed/blog-1/800/450', content: '<p>We built Aureliya to be fast, accessible, and delightful to use.</p>' },
    { slug: 'gift-guide-2025', title: 'Gift Guide 2025', excerpt: 'Top picks for everyone on your list.', image: 'https://picsum.photos/seed/blog-2/800/450', content: '<p>Explore curated selections for every budget and style.</p>' },
    { slug: 'how-we-build', title: 'How we build', excerpt: 'A peek into our frontend performance work.', image: 'https://picsum.photos/seed/blog-3/800/450', content: '<p>We prioritize performance, accessibility, and maintainability.</p>' },
  ])
