            ...
            {showSug && suggestions.length > 0 && (
              <div className="absolute z-50 mt-2 w-[28rem] rounded-xl border border-neutral-200/70 dark:border-neutral-800 bg-white dark:bg-neutral-950 shadow-lg p-2">
                <ul>
                  {suggestions.map(p => (
                    <li key={p.slug}>
                      <Link to={`/product/${p.slug}`} className="flex items-center gap-3 rounded-md px-2 py-2 hover:bg-neutral-50 dark:hover:bg-neutral-900" onMouseDown={(e)=>e.preventDefault()} onClick={()=>setShowSug(false)}>
          ...
          <div className="flex items-center gap-3 relative">
            ...
            {authUser ? (
              <div className="relative group">
                <Link to="/profile" className="flex items-center gap-2 px-2 py-1.5 rounded-md border border-neutral-300 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-900">
                ...
                <div className="invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-opacity absolute right-0 mt-2 w-40 rounded-xl border border-neutral-200/70 dark:border-neutral-800 bg-white dark:bg-neutral-950 shadow-lg p-2 z-50">
                  <ul className="text-sm">
                    <li><Link to="/profile" className="block px-2 py-1 rounded hover:bg-neutral-50 dark:hover:bg-neutral-900">Profile</Link></li>
              ...
              <Link to="/checkout" className="px-3 py-1.5 rounded-md border border-neutral-300 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-900">Login</Link>
            )}
            <button
            ...
            {suggestions.length > 0 && (
              <div className="mb-3 rounded-xl border border-neutral-200/70 dark:border-neutral-800">
                <ul>
                  {suggestions.map(p=> (
                    <li key={p.slug}>
                      <Link to={`/product/${p.slug}`} className="flex items-center gap-3 px-3 py-2 hover:bg-neutral-50 dark:hover:bg-neutral-900" onClick={()=>setOpen(false)}>
